    ...
    return(
        <div className="about">
            ...
            <div className="flex items-center gap-10">
                <div id="card" className="content-center w-150 h-150 bg-none rounded-2xl text-2xl text-white font-light italic p-10 text-center -rotate-2 animate-[slide-to-right_1s_ease-in-out_1] timeline">
                ...
                <div className="w-120 h-170 bg-indigo-600 rounded-2xl rotate-3 animate-[slide-to-left_1s_ease-in-out_1] timeline">

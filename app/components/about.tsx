    ...
    return(
        <div className="about">
            ...
            <div className="flex items-center gap-10">
                <div className="content-center w-150 h-160 bg-indigo-600 rounded-2xl text-2xl text-white font-bold italic p-10 text-center">
                ...
                <div className="w-150 h-200 bg-white rounded-2xl">

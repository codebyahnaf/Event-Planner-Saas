    ...
    return(
        <div className="testimonials">
            <div className="text-white text-5xl font-extrabold text-center">
                What are our users saying about MeetSync?🗣️
            </div>
            <div className="grid grid-cols-2 gap-3">
                <div className="w-120 h-70 bg-none p-7 rounded-2xl animate-[reveal_2s_ease-in-out_1] timeline" id="card">
            ...
            <div className="w-120 h-70 bg-none p-7 rounded-2xl animate-[reveal_2s_ease-in-out_1] timeline" id="card">
                ...
                <p className="text-white font-bold text-3xl">— Jason & Lila M., Newlyweds 👩‍❤️‍👨</p>
            </div>
            <div className="w-120 h-70 bg-none p-7 rounded-2xl animate-[reveal_2s_ease-in-out_1] timeline" id="card">
            ...
            <div className="w-120 h-70 bg-none p-7 rounded-2xl translate-x-60 animate-[reveal_2s_ease-in-out_1] timeline" id="card">
            ...
            <div className="text-white text-5xl font-extrabold text-center translate-y-10"> You get the idea,
               <br />Signup for a <span className="text-indigo-600 underline" id="glow">free 14-day trial</span></div>

    ...
    return(
        <div className="testimonials">
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="w-120 h-70 bg-none p-7 rounded-2xl " id="card">
            ...
            <div className="w-120 h-70 bg-none p-7 rounded-2xl translate-x-60" id="card">
            ...
            <div className="text-white text-5xl font-extrabold text-center translate-y-10"> You get the idea,
               <br />Signup for a <span className="text-indigo-600 underline">free 14-day trial</span></div>
